...
let make = () => {
  ...
  <div className="bg-image min-h-screen py-32 px-48 flex justify-between">
    <div
      ...
      <h1
        className="font-heading uppercase text-6xl font-black
      leading-none">
        "DnD Armory"->React.string
      </h1>
      <p className="text-center mt-10 w-2/3 font-medium text-lg">
